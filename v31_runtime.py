...
def run_v31(
    ...
    *,
    ...
    source_version: str = "dd_engine1-baseline",
    engine_commit: str = "unknown",
) -> dict[str, Any]:
    """Run existing raw computation through the v3.1 L3/L4 boundary.

    The legacy semantic module is intentionally not called. Until an approved
    S07 profile exists, L4 must return MAPPING_UNRESOLVED.
    """
    input_descriptor = {
        "hexagram": que_chu.to_report_dict(),
    ...
    return {
        ...
        "execution": {
            "decision_id": decision_id, "tick": 0,
            "input_hash": input_hash, "runtime_status": "PASSED",
        },
        "raw_measurements": {
            ...
            "f_net_out": None,
            "runtime_trace": [
                {"stage": "L3", "event": "SIE_GRAPH_BUILT", "substantive_edge_count": len(substantive)},
                {"stage": "L3", "event": "KHI_VECTOR_EMITTED", "semantic_label_emitted": False},
            ],
        },
        "semantic_state": {
            "status": "MAPPING_UNRESOLVED", "primary_label": "MAPPING_UNRESOLVED",
            "mapping_profile": {
                "profile_id": "S07_CANONICAL_V31_UNRESOLVED", "version": V31_CONTRACT_VERSION,
                "sha256": "", "status": "UNRESOLVED",
            },
            "mapping_provenance": [{"reason": "No approved S07 mapping profile is available in v3.1."}],
        },
        "uncertainty": {
            "measurement": 0.0, "model": 1.0, "semantic": 1.0,
            "confidence": {
                "score": 0.0, "method": "v3.1-gated-unresolved",
        ...
        "provenance": {
            ...
            "review_records": ["v3.1 canonical layer spec", "pre-v3.1 runtime baseline"],
        },
        "gate_results": {
